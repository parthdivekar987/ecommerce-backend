...
public class OrderServiceImplementation implements OrderService {
    ...
    public Order createOrder(User user, Address shippingAddress) {
        ...
        // FIX: Replaced null check with proper initialization to prevent NullPointerException
        if (createdOrder.getPaymentDetails() == null) {
            createdOrder.setPaymentDetails(new PaymentDetails()); // Assuming a constructor for PaymentDetails
        }
        createdOrder.getPaymentDetails().setStatus("PENDING");

        // FIX: Corrected typo in method name
